      ...
      <div className='md:p-20 p-5'>
        <div className='shadow w-full md:p-10 p-5'>
          ...
          <div className='md:grid grid-cols-[1fr_3fr] w-full'>
            <div>
              <img src={bookDetails?.imageUrl} alt="" className='w-full h-100' />
            </div>
            <div className='px-4'>
              ...
              <div className='mt-10 flex justify-end'>
                <Link to={'/all-books'}> <button className='flex px-4 py-3 bg-blue-800 rounded text-white hover:bg-white hover:text-blue-800 hover:border hover:border-blue-800 '><FaBackward className='mt-1 me-2' />Back</button></Link>
